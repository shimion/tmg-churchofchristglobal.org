...
AitSkeletonUpgrade299;$this->errors=$upgrade->execute();}do_action('ait-skeleton-upgrade',$this);$this->addAdminErrorNotices();}function
...
AitSkeletonUpgrade299;if($upgrade->needsUpgrade()){$upgrade->execute();}}}function
